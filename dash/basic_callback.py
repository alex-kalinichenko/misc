...
@app.callback(
    ...
    prevent_initial_call=False # при обновлении страницы показывать начально заданные данные
)  # val_chosen - то свойство которое выбрано из html.Div value='initial value'
#  val_chosen = ["Fidelity 500 Index Fund", "Fidelity Advisor Freedom 2035 Fund Class A",
#  "Fidelity Freedom 2035 Fund"], но задан переменной для динамического изменения
def update_my_graph(val_chosen):
    if len(val_chosen) > 0:
        ...
        return fig  # возвращается вместе с Output component_property='figure' в dcc.Graph
