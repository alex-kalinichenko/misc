...
# ----- FILE MENU ITEMS -----
# Create a pull down menu that can't be removed and tie it to your menu bar
...
# Add a checkbox option to show line numbers and set the default to checked
line_numbers = IntVar()
line_numbers.set(1)

# Add checkbutton to View with a label and bind line_numbers so we know if the box is
# checked or not
...
# When About is clicked execute a function but also tie it to a shortcut
...
# Bind shortcut to the About and what we want to show
