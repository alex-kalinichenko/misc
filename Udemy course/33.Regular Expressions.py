...
# Create a regex that will match for 5 digit zip codes or zip codes with 5 digits
# a dash and then 4 digits. Here is sample data :
...
# match all of the following phone numbers and then print them.
