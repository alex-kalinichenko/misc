...
<head>
	...
	<title>Студийная фотосессия "Пьеро-Арлекин" - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="портфолио фотосессия пьеро арлекин пьеро-арлекин креативный фотограф виктория балашова" />
	<meta name="description" content="Фотосессия Пеьро-Арлекин креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Пьеро-Арлекин"</h1>
		<br />
		<h2>Фотосессия в образе</h2>
		<br />
		<a href="portfolio-studio-96.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-48.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
        <?php
		/* settings */
		$image_dir = 'studio-98-piero-arlekin/';
		$per_column = 6;
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Пьеро-Арлекин - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотосессия "Пьеро-Арлекин" объединяет два персонажа в одном образе. Модель показывает весёлый и игривый характер, в котором, тем не менее, остаётся место для грусти.</p>
	<br />
	<a href="portfolio-studio-96.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-48.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
