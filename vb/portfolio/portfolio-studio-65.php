...
<head>
	...
	<title>Фотосессия "Romance" - фотосет в студии - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="romance портфолио фотосессия фотосет креативный фотограф виктория балашова" />
	<meta name="description" content="Фотосессия Romance креативного фотографа Виктории Балашовой. " />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Romance"</h1>
		<br /><br />
		<h2>Фотосессия в студии</h2>
		<br />
		<a href="portfolio-studio-60.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-70.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Romance - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотосессия в студии - это тщательная работа фотографа, которая в комплексе с правильно поставленным студийным светом позволяет скрыть недостатки, подчеркнуть ваши достоинства и создать приятную атмосферу. Мне интересно снимать в фотостудии модель в различных образах. В данной фотосессии в студии это вамп, романтика и  римский стиль. Человек перевоплощается, меняя одежду. Она дает свободу движения и раскрепощение. Фотографии – это то, что остается с нами на всю жизнь! Всегда приятно пересматривать снимки разных жизненных событий и периодов, поэтому важно не упустить каждый момент счастья. Я предлагаю подарить такие мгновения своим близким – любой вид фотосессии можно преподнести в качестве подарка!</p>
	<br />
	<a href="portfolio-studio-60.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-70.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
