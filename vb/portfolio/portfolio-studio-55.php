...
<head>
	...
	<title>Фотосессия "Non-Stop" - фотосет в студии - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="портфолио фотосессия non-stop виктория балашова креативный фотограф" />
	<meta name="description" content="Фотосессия Non-Stop креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Non-Stop"</h1>
		<br /><br />
		<h2>Фотосессия в студии</h2>
		<br />
		<a href="portfolio-studio-53.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-60.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Non-Stop - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Этот фотосет называется "Non-Stop". За 3 часа были сняты 11 человек. На каждого в среднем приходилось по 15 минут. За это небольшое время Вика Балашова успела раскрыть неповторимый образ каждого человека и сфотографировать его в разных декорациях. Это была беспрецедентная акция, потому что обычно фотографу надо как минимум пару часов, чтобы снимаемы раскрылся и почувствовал себя свободно. В этой фотосессии не принимали участие модели. Это были обычные люди, приглашённые через <a href="http://vk.com/victoriabalashova" title="В Контакте" rel="nofollow" target="_blank">мою группу в Контакте</a>.</p>
	<br />
	<a href="portfolio-studio-53.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-60.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
