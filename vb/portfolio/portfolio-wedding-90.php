...
<head>
	...
	<title>Свадебная фотосессия Влада и Анны - Виктория Балашова - креативный фотограф.</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="портфолио свадебная фотосессия креативный фотограф виктория балашова царицыно прогулка" />
	<meta name="description" content="Свадебная фотосессия Влада и Анны креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Свадебная фотосессия Влада и Анна</h1>
		<br />
		<h2>Избранные фото: Царицыно</h2>
		<br />
		<a href="portfolio-wedding-80.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-wedding-69.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
        <?php
		/* settings */
		$image_dir = 'wedding-90-vlad-anna/';
		$per_column = 6;
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Свадебная фотосессия в Царицыно - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Свадебная фотосессия в музее-усадьбе Царицыно – это мечта. Недавно отреставрированный, этот парк уже успел подарить сотням молодых пар волшебные свадебные фотографии. И не только благодаря расположенному рядом ЗАГСу. Этот парк является действительно очаровательным местом, одним из любимых свадебными фотографами. Фотосессия в Царицыно - это торжественное мероприятие, яркое и незабываемое для молодоженов, с одной стороны; технически сложное и ответственное для фотографа, с другой. Царицыно – это настоящий шедевр, поэтому в любой сезон и в любую погоду здесь уютно и красиво. Осенью в Москве вы не найдете места прекраснее, а осенняя красота природы сделает фотосессию бесподобной. И зимой, и летом фотосессия здесь будет разнообразной. А фотографии получатся красочные, даже, несмотря на снег или дождь, ведь в парке довольно немало мест для прогулки и фотосъемки. На фоне такой живописной местности вы не сможете скрывать отличное настроение и положительные эмоции! Через много лет, просматривая свадебный альбом, вы снова будете возвращаться в день вашей свадьбы и окунаться в те же чувства и ощущения праздничного дня.</p>
	<br />
	<a href="portfolio-wedding-80.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-wedding-69.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
