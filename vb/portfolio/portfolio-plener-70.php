...
<head>
	...
	<title>Фотосессия "Осень" в Коломенском парке на пленэре - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="фотосессия парк коломенское фотография фотограф виктория балашова осень пленэр" />
	<meta name="description" content="Фотосессия Осень на пленэре креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия в Коломенском "Осень"</h1>
		<br />
		<h2>Фотосессия на пленере</h2>
		<br />
		<a href="portfolio-plener-60.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-plener-80.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Осенняя фотосессия в парке Коломенское на пленэре" /></a>';
    ...
    <br />
	<p>Коломенское – самый популярный парк Москвы. Здесь есть все, что нужно фотографу для проведения разных видов съемки: свадебных фотосессий,  фотосессий Love Story и индивидуальной фотосессии на пленере. Архитектура, особенности ландшафта и сама природа дарят свободу мысли и фантазии. Главное, что все это собрано в одном месте и поэтому можно не сомневаться, что фотографии будут разнообразными.</p>
	<p>Моей моделью была Анна. В Коломенском есть место похожее на аллею за церковью Вознесения, это место я выбрала натурой для фотосъемок. Прогуливающаяся рядом пара подарила нам огромный венок из осенних листьев, который мы использовали во время фотосъемки на пленере. Надо сказать, что обилие красок было потрясающим и на фотографиях они выглядели как нельзя кстати. Несмотря на популярность парка, в Коломенском можно найти уединение. Анна впервые заказала фотосессию на пленэре и ей это очень понравилось. Она чувствовала себя очень комфортно и осталась очень довольна результатом!</p>
	<br />
	<a href="portfolio-plener-60.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-plener-80.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
