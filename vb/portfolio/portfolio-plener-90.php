...
<head>
	...
	<title>Фотосессия "Кислород" на пленере в Подмосковье - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="кислород пленэр портфолио фотосессия фотограф виктория балашова подмосковье" />
	<meta name="description" content="Фотосессия Кислород на пленере в Подмосковье креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосесия "Кислород"</h1>
		<br /><br />
		<h2>На пленере в Подмосковье</h2>
		<br />
		<a href="portfolio-plener-80.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-plener-49.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия на пленере в Подмосковье - Кислород - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотосессия была снята на пленере в Подмосковье</p>
	<p>Фотосессия на пленере - это прекрасная замена студийной фотосессии в «живых» декорациях. Это может быть определенный парк, усадьба или торговый центр. Но выбор многих, особенно летом, сводится к поездке за город и приобщению с природой. Поля, стога сена, голубое небо и полевые цветы, как нельзя лучше выразят парящее состояние души и отразятся улыбками на ваших лицах. Главное, что все это собрано в одном месте и значит фотографии будут разнообразными. Подмосковье является прекрасным местом для уединения от шумного города. Рекомендую выездную фотосессию на плэнере не только для влюбленных пар, но и для любых компаний.</p>
	<br />
	<a href="portfolio-plener-80.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-plener-49.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
