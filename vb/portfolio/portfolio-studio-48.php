...
<head>
	...
	<title>Фотосессия "Psychodelic" в студии - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="psychodelic портфолио фотосессия фотосет виктория балашова креативный фотограф вдохновение" />
	<meta name="description" content="Фотосессия psychodelic креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Psychodelic"</h1>
		<br /><br />
		<h2>Фотосессия в студии</h2>
		<br />
		<a href="portfolio-studio-98.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-50.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
        <?php
		/* settings */
		$image_dir = 'studio-48-psychodelic/';
		$per_column = 6;
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Psychedelic - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Что такое фотосессия love story? Это рассказ о паре, выраженный в серии снимков, которые лучше любых слов расскажут об отношениях влюбленных. Романтическая и трогательная, яркая и дерзкая, или, наоборот,  светлая и нежная, love story фотосессия будет достойным воспоминанием о том,  как зарождалось это прекраснее чувство.  Любовь существует столько, сколько на свете живут люди. Все мы ищем свою половинку, и часто история такого поиска может стать основой для увлекательного романа. Поэтому, когда вторая половина уже найдена, хочется сохранить в памяти основные этапы ваших взаимоотношений.</p>
	<br />
	<a href="portfolio-studio-98.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-50.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
