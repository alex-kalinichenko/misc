...
<head>
	...
	<title>Фотосессия "Inspiration" в студии - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="inspiration портфолио фотосессия фотосет виктория балашова креативный фотограф вдохновение" />
	<meta name="description" content="Фотосессия Inspiration креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Inspiration"</h1>
		<br /><br />
		<h2>Фотосессия в студии</h2>
		<br />
		<a href="portfolio-studio-48.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-53.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Inspiration - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотосессия в студии требует особого искусства фотографа, который с помощью света и тени должен передать неповторимость модели, черты лица и особенности характера. Согласитесь, если уж заказывать фотосессию в студии, то непременно необычную. Студия на Брюсовом переулке привлекла, прежде всего, своими текстурами. Было интересно посмотреть, что получится из этого минимализма. В зависимости от фотографируемой текстуры, модель примеряла одежду  разных цветов, в итоге появилось несколько образов. Соответствующее освещение придало таинственность и загадочность. Результатом подобного мероприятия стали невероятно привлекательные и оригинальные снимки. Сегодня человек любого пола, возраста, профессии может побывать в роли модели и стать красивым, брутальным, сексуальным. Не важно, какая у него, фигура, рост и вес.</p>
	<br />
	<a href="portfolio-studio-48.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-53.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
