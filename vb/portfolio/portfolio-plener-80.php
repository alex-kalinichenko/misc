...
<head>
	...
	<title>Фотосессия на мосту Багратион в Москва-сити - Портфолио на пленере - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="багратион портфолио фотосессия пленер пленэр фотограф виктория балашова москва дизайнер москва-сити" />
	<meta name="description" content="Фотосессия на мосту Багратион в Москва-сити креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия на мосту Багратион в Москва-сити</h1>
		<br />
		<h2>Фотосессия на пленере</h2>
		<br />
		<a href="portfolio-plener-70.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-plener-90.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
        <?php
		/* settings */
		$image_dir = 'plener-80-natasha-bagration/';
		$per_column = 6;
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия на пленэре мост Багратион - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотосессия на мосту Багратион - прекрасное решение для тех, кто хочет получить красивые фотографии в холодное время года. Моя фотосессия проводилась в кафе на мосту Багратион. Необычный интерьер, огромные окна, естественный свет, все это создает атмосферу студии. Я предпочла фотографировать днем, поскольку людей в это время бывает мало и моя модель смогла по-настоящему раскрепоститься. Наталья великолепно смотрелась на фоне возвышающихся зданий Москва-Сити. Фотографии выглядят очень стильно и производят впечатление, что фотосъемка проходила в Европе. Фотосессия показывает образ девушки, жительницы мегаполиса, которую окружают небоскрёбы, построенные из стекла и бетона. Вокруг кипит жизнь большого города.</p>
	<p>Фотосъемка может проводится с ассистентом или с привлечением визажиста. В отличии он студийной фотосессии, фотосъемка на мосту Багратион будет стоить недорого. Я могу рекомендовать подобные фотосеты как замену фотосессии на пленере.</p>
	<br />
	<a href="portfolio-plener-70.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-plener-90.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
