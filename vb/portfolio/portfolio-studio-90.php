...
<head>
	...
	<title>Студийная фотосессия "Women" (Женщины) посвященная Давиду Лашапелю - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="фотосессия женщины давид лашапель посвящено портфолио креативный фотограф виктория балашова" />
	<meta name="description" content="Фотосессия Women (Женщины) посвященная Давиду Лашапелю креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосет "Women" (Женщины)</h1>
		<br />
		<h2>Фотосессия посвящена Давиду Лашапелю</h2>
		<br />
		<a href="portfolio-studio-85.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-92.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Женщины (Women) - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотосессию "Women" - Женщины фотограф Вика Балашова посвятила знаменитому фотографу Давиду Лашапелю. Его работы отличаются особым ироничным стилем сюрреалистического гламура.</p>
	<br />
	<a href="portfolio-studio-85.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-92.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
