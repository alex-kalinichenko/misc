...
<head>
	...
	<title>Фотосессия в Кусково г. Москва на пленере - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="фотосессия кусково москва фотография фотограф виктория балашова модель" />
	<meta name="description" content="Фотосессия в Кусково на пленэре креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия в парке Кусково (Москва)</h1>
		<br />
		<h2>Фотосет на плэнере</h2>
		<br />
		<a href="portfolio-plener-50.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-plener-70.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
        <?php
		/* settings */
		$image_dir = 'plener-60-natasha-kuskovo/';
		$per_column = 6;
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия на пленэре в Кусково - креативный фотограф Виктория Балашова" /></a>';
    ...
    <br />
	<p>Единственное место, которое по красоте сравнивается с усадьбой Архангельское - это Кусково. Белоснежные статуи, подстриженные газоны, беседки и архитектура XVIII века помогают почувствовать себя особой из прошлого. Фотосессия происходила в начале осени, листья еще не успели пожелтеть и фотографироваться можно было в обычном летнем платье. Наталья, дизайнер одежды, выбрала для натуры именно это парк. Алый сарафан - это ее работа, заказ - фотосъемка для рекламного буклета. Модель попросила сфотографировать себя с бокалом шампанского, что поспособствовало созданию веселой атмосферы. Наташа в этой фотосессии раскрывает образ хрупкой девушки, которая среди сплошных массивов зелени и редких заброшенных сооружений преображает всё вокруг. Она вносит законченный штрих в гармонию каждой фотографии.</p>
	<p>Парк Кусково идеально подойдет также для фотосессии love story, парковые павильоны создают интимную обстановку и пара может в любой момент скрыться от посторонних глаз. Фотосессия на пленере в таком месте как парк Кусково, гарантировано подарит прекрасные снимки и хорошее настроение. Я рекомендую этот парк для всех любителей природы, красивых пейзажей, старинных строений и уютных уголков в тиши парка.</p>
	<br />
	<a href="portfolio-plener-50.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-plener-70.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
