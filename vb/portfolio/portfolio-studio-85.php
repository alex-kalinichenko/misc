...
<head>
	...
	<title>Студийная фотосессия "Serenity" - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="фотосессия serenity портфолио креативный фотограф виктория балашова" />
	<meta name="description" content="Студийная фотосессия Serenity креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Serenity"</h1>
		<br />
		<h2>Фотосессия в студии</h2>
		<br />
		<a href="portfolio-studio-80.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-90.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Serenity - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотография – это память. Это то, какими мы были в тот прекрасный миг жизни. К счастью, фотостудии все больше заинтересованы в работе с непрофессиональными моделями. Потому что именно «непрофессиональность» зачастую позволяет создать максимально живые, искренние и настоящие фотографии, без «маски глянца». Мне поступил необычный заказ на фотосессию в ванной. Моя идея понравилась модели, мы решили снять журнальный гламур. Эля даже не подозревала, что позировать это так легко, а уединение в  фотостудии только раскрепостило ее. Если у вас появилось желание сделать фотосессию у профессионала в студии - посмотрите на себя по-новому! Моё предложение - каждому увидеть себя на своём максимуме!!!</p>
	<br />
	<a href="portfolio-studio-80.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-90.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
