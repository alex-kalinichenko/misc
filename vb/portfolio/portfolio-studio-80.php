...
<head>
	...
	<title>Фотосессия беременной - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="фотосессия беременная стиль ню портфолио креативный фотограф виктория балашова" />
	<meta name="description" content="Фотосессия для беременных в стиле ню креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия для беременных</h1>
		<br />
		<h2>Фотосессия в студии</h2>
		<br />
		<a href="portfolio-studio-75.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-85.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
        <?php
		/* settings */
		$image_dir = 'studio-80-lena-pregnant/';
		$per_column = 6;
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия беременных - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотосессия беременных - это очень важная и трогательная фотосъемка, наполненная любовью и нежностью. Фотосессию беременности лучше проводить на 25-31 неделе, так как именно в этот период у будущей мамы особо четко прорисовывается животик и она полна сил, чтобы участвовать в продолжительной фотосъемке. Очень важно, чтобы модель чувствовала себя расслаблено и комфортно в фотостудии. Фотосессия беременных проводится как с мужем, с семьей, так и индивидуально. Мою модель зовут Елена, она фотографировалась на 8 месяце беременности. Беременность проходила комфортно, и она могла без труда позировать. Елена предпочла фотосессию «ню», я решила сфотографировать ее в красных тонах и завуалировать ее образ маской.</p>
	<p>Фотосессии с беременными показывают нам истинную красоту. Женщина, ждущая ребёнка прекрасна и очаровательна. Она находится в особенном приподнятом эмоциональном состоянии и излучает особую энергетику, передающуюся через фотографию посредством невидимых флюидов радости и счастья.</p>
	<p>Стоимость фотосессии для беременных ничем не отличается от обычной. Также можно менять несколько образов и фотографироваться в различных интерьерах. На цене это никак не отражается.</p>
	<p>Всем будущим мамам я рекомендую сделать фотосессию беременной, чтобы навсегда запечатлеть на фото этот чудесный период, потому что беременность - это замечательно!</p>
	<br />
	<a href="portfolio-studio-75.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-85.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
