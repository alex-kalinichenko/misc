...
<head>
	...
	<title>Студийная фотосессия "Amarcord" - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="портфолио фотосессия amarcord креативный фотограф виктория балашова" />
	<meta name="description" content="Фотосессия Amarcord креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Amarcord"</h1>
		<br />
		<h2>Фотосет в стиле реализма</h2>
		<br />
		<a href="portfolio-studio-92.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-96.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Amarcord - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотосессия "Amarcord" выполнена в стиле реализма. Это самый модный стиль среди выставочных фотографов и критиков. Он может нравится или нет, но нельзя оставлять его без внимания. Кто-то позитивно реагирует на этот фотосет, кто-то негативно, но как правило, никто не остаётся равнодушным.</p>
	<p>Модель предстаёт перед нами в трагическом стиле. Её внутреннюю драму помогает передать окружающий интерьер, в котором царит разруха, уныние и безнадёжность. Обстановка, окружающая героиню, усиливает и помогает понять депрессивное состояние модели. Нам остаётся только гадать, что твориться в её душе.</p>
	<br />
	<a href="portfolio-studio-92.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-96.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
