...
<head>
	...
	<title>Студийные фотосессии "Ангел А" и "Мария-Антуанетта" - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="портфолио фотосессия ангел А мария-антуанетта мария антуанетта креативный фотограф виктория балашова" />
	<meta name="description" content="Фотосессия Ангел А и Мария-Антуанетта креативного фотографа Виктории Балашовой. " />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Ангел А" и "Мария-Антуанетта"</h1>
		<br />
		<h2>Фотосессия в образе</h2>
		<br />
		<a href="portfolio-studio-94.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-98.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
        <?php
		/* settings */
		$image_dir = 'studio-96-angel-maria-antuanetta/';
		$per_column = 6;
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Ангел А и Мария-Антуанетта - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Здесь представлены две фотосессии одной модели "Ангел А" и "Мария-Антуанетта". Модель раскрывает перед нами образы ангела и австрийской принцессы и французской королевы Марии-Антуанетты. Трагизм Марии-Антуанетты заключается в том, что она стала жертвой революции и была казнена собственным народом. Перед французской революцией в стране вспыхнули голодные бунты. Ей приписывают фразу: "У них нет хлеба? Тогда пусть едят пирожные". Её современники отмечали её легкомысленность и страсть к развлечениям.</p>
	<br />
	<a href="portfolio-studio-94.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-98.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
