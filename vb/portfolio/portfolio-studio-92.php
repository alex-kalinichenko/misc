...
<head>
	...
	<title>Студийная фотосессия "Восточные танцы" - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="портфолио студия фотосессия восточные танцы креативный фотограф виктория балашова" />
	<meta name="description" content="Фотосессия Восточные танцы креативного фотографа Виктории Балашовой. " />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Восточные танцы"</h1>
		<br />
		<h2>Фотосессия в студии</h2>
		<br />
		<a href="portfolio-studio-90.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-94.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
        <?php
		/* settings */
		$image_dir = 'studio-92-lena-east-dance/';
		$per_column = 6;
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Восточные танцы - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотосессия "Восточные танцы" показывает нам прелесть восточной культуры и одной из самых красивых её сторон - восточного танца. Модель профессионально занимается восточными танцами. Все её движения поражают воображение своей гармонией и пластикой.</p>
	<br />
	<a href="portfolio-studio-90.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-94.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
