...
<head>
	...
	<title>Фотосессия "Wonder" Портфолио в студии - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="портфолио фотосессия портфолио креативный фотограф виктория балашова" />
	<meta name="description" content="Фотосессия wonder креативного фотографа Виктории Балашовой" />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Wonder"</h1>
		<br /><br />
		<h2>Фотосессия в студии</h2>
		<br />
		<a href="portfolio-studio-70.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-80.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Wonder - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
    <p>Эту фотосессию можно посмотреть в виде слайд-шоу. Ссылка на YouTube: <a href="http://youtu.be/jWuNOiFadzM" rel="nofollow" target="_blank" title="Слайд-шоу">http://youtu.be/jWuNOiFadzM</a></p>
    <br />
	...
	<br />
	<p>Фотосессия "Wonder" даёт нам почувствовать удивление и изумление. Рассматривая фотографии этого фотосета вы заметите как удивительно человек может преображаться и становится похожим на куклу или манекен.</p>
	<br />
	<a href="portfolio-studio-70.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-80.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
