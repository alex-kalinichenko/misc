...
<head>
	...
	<title>Фотосессия "Narcissus" - студийное портфолио - Виктория Балашова креативный фотограф</title>
	<meta name="author" content="Виктория Балашова"/>
	<meta name="copyright" content="Виктория Балашова"/>
	<meta name="keywords" content="портфолио фотосессия narcissus виктория балашова креативный фотограф" />
	<meta name="description" content="Фотосессия Narcissus креативного фотографа Виктории Балашовой. " />
...
<div id="wrapper"><!--ширина 1100px -->
  ...
  <div id="middle">
	 ...
	 <div class="sidebar" id="sideRight">  <!--  ПРАВЫЙ САЙДБАР - МЕСТО ДЛЯ КОНТЕНТА 998px  -->
		...
		<h1>Фотосессия "Narcissus"</h1>
		<br /><br />
		
		<h2>Фотосет в студии</h2>
		<br />
		<a href="portfolio-studio-65.php" class="previous" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
		<a href="../portfolio.php"  class="back_portfolio" title="Портфолио">Вернуться в портфолио</a>
		<a href="portfolio-studio-75.php"  class="next"   title="Следующая фотосессия">Следующая фотосессия-></a>
        <br />
     ...
     <table cols="1">
      <tr>
       <td>
		...
		<img src="',$image_dir,$file,'" width="150" height="150" alt="Фотосессия Narcissus - креативный фотограф Виктория Балашова" /></a>';
	...
	<br />
	<p>Фотосессия в студии – это тот волшебный мир, где меняется мировосприятие, преображаются лица, исполняются самые оригинальные желания и фантазии.</p>
	<p>Я люблю снимать людей разной внешности и всех возрастов. Женщины хотят долго оставаться молодыми и желанными, и мое творчество помогает запечатлеть этот момент. Мои креативные фотографии дают им возможность увидеть максимум  красоты и природной грации, которая свойственна каждой из них. Во время фотосессии в студии, модель только первые полчаса выглядит напряженно и скованно. Потом процесс становится настолько увлекателен, что свобода движений преображает человека. Фотосессия в студии это прекрасная возможность отдохнуть с пользой для себя и приобрести креативные фотографии на долгую память. Мастерство фотографа, компьютерные технологии, креативный подход к творчеству и Ваша неотразимая красота вкупе создадут ошеломительный, потрясающий и необычный образ.</p>
	<br />
	<a href="portfolio-studio-65.php" class="previous_bottom" title="Предыдущая фотосессия"><-Предыдущая фотосессия</a>
	<a href="../portfolio.php"  class="back_portfolio_bottom" title="Портфолио">Вернуться в портфолио</a>
	<a href="portfolio-studio-75.php"  class="next_bottom"   title="Следующая фотосессия">Следующая фотосессия-></a>
	<br />
	<br />
